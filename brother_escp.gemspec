...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Print text and images to a Brother label printer with ESC/P.}
  spec.description   = %q{Print text and images to a Brother label printer with ESC/P.}
